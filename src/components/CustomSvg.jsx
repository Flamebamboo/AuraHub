...
export const CustomSvg = ({ height, width, fillColor, style, variant }) => {
  if (variant === 'hubsIcon') {
    return (
      <Svg {...style} viewBox="0 -0.5 32 32" shape-rendering="crispEdges">
        <Path
          stroke="#ffffff"
